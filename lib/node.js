...
innerExports['src::storage.memory'] = (() =>{
                    ...
                    let var_init_locked_1607342758436;
    
                    let var_class_1607342758436;
    
                    

                    let var_global_main_1607342758436 ;
    
                    return function(){
    
                        
        if(!var_init_locked_1607342758436){
    ...
    removeItem(key){
      ...
      if(keys.includes(key)){
         ...
         delete storage[key] ;
            ...
            var_class_1607342758436 = class extends main{
                ...
                get __ZBEE_CURRENT_CLASS__(){
                    ...
                    return var_class_1607342758436 ;
                }
            ...
            main = var_class_1607342758436 ;
        
var_global_main_1607342758436 = main;

            var_init_locked_1607342758436 = true ;
        }
        
    
                        return new var_global_main_1607342758436() ;
                    } ;
