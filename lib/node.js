...
innerExports['src::microservice.server'] = (() =>{
                    ...
                    let var_init_locked_1607403090828;
...
innerExports['src::storage.memory'] = (() =>{
                    ...
                    let var_init_locked_1607403446066;
    
                    let var_class_1607403446066;
    
                    

                    let var_global_main_1607403446066 ;
    
                    return function(config = {}){
    
                        
        if(!var_init_locked_1607403446066){
    ...
    async removeItem(key){
      ...
      if(keys.includes(key)){
         ...
         delete storage[key] ;
            ...
            var_class_1607403446066 = class extends main{
                ...
                get __ZBEE_CURRENT_CLASS__(){
                    ...
                    return var_class_1607403446066 ;
                }
            ...
            main = var_class_1607403446066 ;
        
var_global_main_1607403446066 = main;

            var_init_locked_1607403446066 = true ;
        }
        
    
                        return new var_global_main_1607403446066(config) ;
                    } ;
...
innerExports['src::microservice.config.datasources'] = (() =>{
                    ...
                    let var_init_locked_1607403090862;
...
return result ;
        ...
        if(!var_init_locked_1607403090862){

            storageMemory = include('src::storage.memory');
isString = include('src::is.string');
isObject = include('src::is.object.simple');

            var_init_locked_1607403090862 = true ;
        }
...
innerExports['src::microservice.config.server'] = (() =>{
                    ...
                    let var_init_locked_1607403148071;
...
function getDefaultParamTarget(method){
    ...
    switch(method){
        ...
        if(!var_init_locked_1607403148071){

            isString = include('src::is.string');
isObject = include('src::is.object.simple');
isFunction = include('src::is.function');

            var_init_locked_1607403148071 = true ;
        }
...
innerExports['src::microservice.config'] = (() =>{
                    ...
                    let var_init_locked_1607332100804;
