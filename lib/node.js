...
innerExports['src::microservice.server'] = (() =>{
                    ...
                    let var_init_locked_1607321382776;
...
.listen(port) ;
        ...
        if(!var_init_locked_1607321382776){

            config = include('src::microservice.config')();

            var_init_locked_1607321382776 = true ;
        }
...
innerExports['src::storage.memory'] = (() =>{
                    ...
                    let var_init_locked_1607325981329;
    
                    let var_class_1607325981329;
    
                    

                    let var_global_main_1607325981329 ;
    
                    return function(){
    
                        
        if(!var_init_locked_1607325981329){
    ...
    removeItem(key){
      ...
      if(keys.includes(key)){
         ...
         delete storage[key] ;
            ...
            var_class_1607325981329 = class extends main{
                ...
                get __ZBEE_CURRENT_CLASS__(){
                    ...
                    return var_class_1607325981329 ;
                }
            ...
            main = var_class_1607325981329 ;
        
var_global_main_1607325981329 = main;

            var_init_locked_1607325981329 = true ;
        }
        
    
                        return new var_global_main_1607325981329() ;
                    } ;
...
innerExports['src::microservice.config.datasources'] = (() =>{
                    ...
                    let var_init_locked_1607325981304;
...
return result ;
        ...
        if(!var_init_locked_1607325981304){

            storageMemory = include('src::storage.memory');
isString = include('src::is.string');
isObject = include('src::is.object.simple');

            var_init_locked_1607325981304 = true ;
        }
...
innerExports['src::microservice.config'] = (() =>{
                    ...
                    let isDefined,processDatasourceMap;
    
                    let var_init_locked_1607322129764;
...
innerExports['src::microservice.datasource'] = (() =>{
                    ...
                    let var_init_locked_1607326409979;
 ...
 */
 ...
 function main(name){
    ...
    return config.datasources[name] ;
        ...
        if(!var_init_locked_1607326409979){

            config = include('src::microservice.config')();

            var_init_locked_1607326409979 = true ;
        }
