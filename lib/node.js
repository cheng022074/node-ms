...
innerExports['src::microservice.server'] = (() =>{
                    ...
                    let var_init_locked_1607335575032;
...
innerExports['src::storage.memory'] = (() =>{
                    ...
                    let var_init_locked_1607335131475;
    
                    let var_class_1607335131475;
    
                    

                    let var_global_main_1607335131475 ;
    
                    return function(){
    
                        
        if(!var_init_locked_1607335131475){
    ...
    removeItem(key){
      ...
      if(keys.includes(key)){
         ...
         delete storage[key] ;
            ...
            var_class_1607335131475 = class extends main{
                ...
                get __ZBEE_CURRENT_CLASS__(){
                    ...
                    return var_class_1607335131475 ;
                }
            ...
            main = var_class_1607335131475 ;
        
var_global_main_1607335131475 = main;

            var_init_locked_1607335131475 = true ;
        }
        
    
                        return new var_global_main_1607335131475() ;
                    } ;
...
innerExports['src::microservice.config.server'] = (() =>{
                    ...
                    let var_init_locked_1607334562601;
...
function getDefaultParamTarget(method){
    ...
    switch(method){
        ...
        if(!var_init_locked_1607334562601){

            isString = include('src::is.string');
isObject = include('src::is.object.simple');
isFunction = include('src::is.function');

            var_init_locked_1607334562601 = true ;
        }
