...
innerExports['src::microservice.server'] = (() =>{
                    ...
                    let var_init_locked_1607517432506;
...
innerExports['src::file.read'] = (() =>{
                    ...
                    let var_init_locked_1607517432604;
...
if(await isFile(path)){
    ...
    return new Promise((resolve , reject) => readFile(path , (error , data) => error ? reject(error) : resolve(data))) ;
        ...
        if(!var_init_locked_1607517432604){

            isFile = include('src::is.file');

            var_init_locked_1607517432604 = true ;
        }
...
innerExports['src::file.read.text'] = (() =>{
                    ...
                    let var_init_locked_1607517432579;
 ...
 */
 ...
 async function getText(path) {
    ...
    if(data){
        ...
        if(!var_init_locked_1607517432579){

            read = include('src::file.read');

            var_init_locked_1607517432579 = true ;
        }
...
innerExports['src::file.read.json'] = (() =>{
                    ...
                    let var_init_locked_1607517432568;
 ...
 */
 ...
 function getJSON(data){
    ...
    if(data){
        ...
        if(!var_init_locked_1607517432568){

            read = include('src::file.read.text');
parse = include('src::json.parse');

            var_init_locked_1607517432568 = true ;
        }
...
innerExports['src::storage.memory'] = (() =>{
                    ...
                    let var_init_locked_1607517432551;
    
                    let var_class_1607517432551;
    
                    

                    let var_global_main_1607517432551 ;
    
                    return function(config = {}){
    
                        
        if(!var_init_locked_1607517432551){
    ...
    async removeItem(key){
      ...
      if(keys.includes(key)){
         ...
         delete storage[key] ;
            ...
            var_class_1607517432551 = class extends main{
                ...
                get __ZBEE_CURRENT_CLASS__(){
                    ...
                    return var_class_1607517432551 ;
                }
            ...
            main = var_class_1607517432551 ;
        
var_global_main_1607517432551 = main;

            var_init_locked_1607517432551 = true ;
        }
        
    
                        return new var_global_main_1607517432551(config) ;
                    } ;
...
innerExports['src::array.from'] = (() =>{
                    ...
                    let var_init_locked_1594040395286;
...
return [
    data
        ...
        if(!var_init_locked_1594040395286){

            isEmpty = include('src::is.empty');
isString = include('src::is.string');

            var_init_locked_1594040395286 = true ;
        }
...
innerExports['src::environment.name'] = (() =>{
                    ...
                    let var_once_value_1594040395244;
...
return 'other' ;
        ...
        if(var_once_value_1594040395244){

            return var_once_value_1594040395244 ;

        }
        return var_once_value_1594040395244 = main.call(this ) ;
...
innerExports['src::id.generate'] = (() =>{
                    ...
                    let var_init_locked_1598655699228;
 ...
 */
 ...
 function main(prefix = 'zb-'){
    ...
    return `${prefix}${count ++}` ;
        ...
        if(!var_init_locked_1598655699228){

            getName = include('src::environment.name');

            var_init_locked_1598655699228 = true ;
        }
...
innerExports['src::axios'] = (() =>{
                    ...
                    let var_init_locked_1607517432629;
 ...
 */
 ...
 function processUpload(options , files){
    ...
    return {
        ...
        if(!var_init_locked_1607517432629){
...
isString = include('src::is.string');
            ...
            var_init_locked_1607517432629 = true ;
        }
...
innerExports['src::microservice.config.datasources'] = (() =>{
                    ...
                    let var_init_locked_1607517432536;
...
return result ;
        ...
        if(!var_init_locked_1607517432536){
...
isObject = include('src::is.object.simple');
            ...
            var_init_locked_1607517432536 = true ;
        }
...
innerExports['src::microservice.config.server'] = (() =>{
                    ...
                    let var_init_locked_1607517432639;
    ...
    switch(method){
        ...
        case 'put':
            ...
            return 'body' ;
                    ...
                    return function(server , rootPath){
    
                        
        if(!var_init_locked_1607517432639){

            isString = include('src::is.string');
isObject = include('src::is.object.simple');
isFunction = include('src::is.function');

            var_init_locked_1607517432639 = true ;
        }
        
    
                        return main.call(this , server , rootPath) ;
                    } ;
...
innerExports['src::microservice.config'] = (() =>{
                    ...
                    let var_init_locked_1607517432522;
